...
import { executePaymentHotPost, executePaymentViewCv, executePaymentVip } from "@/fetchData/Transaction";
...
const VipPaymentSuccess = () => {
  ...
  const createNewOrder = async (data) => {
    ...
    let res = await executePaymentVip(data);
    if (res && res.data.errCode === 0) {
      //   toast.success(res.errMessage);
      localStorage.removeItem("orderData");
      setMessage(
        "Upgrade to VIP successfully, hope you enjoy our advanced features !!!"
      );
    } else {
