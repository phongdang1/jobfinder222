...
const JobCard = ({ job, currentPage }) => {
  ...
  return (
    <div
      key={job.id}
      className="bg-white shadow-md rounded-md p-3 flex space-x-4 border border-gray-200 cursor-pointer hover:bg-primary/5 group"
    >
      {/* Company logo */}
      <div className="w-32 h-32 flex items-center justify-center p-4 border-1 rounded-lg">
        <img
          src={
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-col">
          <div className="flex justify-between gap-2">
            <h3
              onClick={handleClick}
              className="text-lg font-semibold text-gray-900 mt-1 group-hover:text-primary"
            >
              {job.postDetailData?.name}
            </h3>
            <span className="px-4 py-1 mr-2 flex justify-center items-center text-xs font-semibold rounded-full bg-purple-100 text-purple-700">
