        ...
        <div>
            <div className="flex flex-col md:flex-row w-full max-w-7xl mx-auto px-4">
                ...
                <div className="w-full md:w-1/4  p-4 rounded-lg mb-4 md:mb-0 to-purple-100">
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700">Day of posting</label>
                        <div className="flex flex-col">
                            <label className="inline-flex items-center mt-2">
                                <input type="checkbox" className="form-checkbox" />
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 pr-3 flex flex-col space-y-4">
                            <div className="flex items-start space-x-4">
                                <img src={ConnectLogo} alt="Job" className="w-16 h-16 mr-3 object-cover rounded-lg" />
                                <div className="flex-1">
                                    <p className="text-black font-medium text-sm mb-1">FPT Software.</p>
                                    <div className="flex items-center">
                                        <h4 className="text-lg font-semibold">Software Developer</h4>
                                        <span className="bg-purple-100 text-purple-700 px-2 py-1 text-xs font-semibold rounded-full ml-4">Full-time</span>
                                    </div>
                                    ...
                                    <div className="text-gray-700 text-sm mt-2">
                                        <p>This role involves developing, testing, and maintaining software solutions for clients. You will work closely with cross-functional teams.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 pr-3 flex flex-col space-y-4">
                            <div className="flex items-start space-x-4">
                                <img src={DigiflexLogo} alt="Job" className="w-16 h-16 mr-3 object-cover rounded-lg" />
                                <div className="flex-1">
                                    <p className="text-black font-medium text-sm mb-1">FPT Software.</p>
                                    <div className="flex items-center">
                                        <h4 className="text-lg font-semibold">Software Developer</h4>
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 pr-3 flex flex-col space-y-4">
                            <div className="flex items-start space-x-4">
                                <img src={EsportLogo} alt="Job" className="w-16 h-16 mr-3 object-cover rounded-lg" />
                                <div className="flex-1">
                                    <p className="text-black font-medium text-sm mb-1">FPT Software.</p>
                                    <div className="flex items-center">
                                        <h4 className="text-lg font-semibold">Software Developer</h4>
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 pr-3 flex flex-col space-y-4">
                            <div className="flex items-start space-x-4">
                                <img src={TechLogo} alt="Job" className="w-16 h-16 mr-3 object-cover rounded-lg" />
                                <div className="flex-1">
                                    <p className="text-black font-medium text-sm mb-1">FPT Software.</p>
                                    <div className="flex items-center">
                                        <h4 className="text-lg font-semibold">Software Developer</h4>
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 pr-3 flex flex-col space-y-4">
                            <div className="flex items-start space-x-4">
                                <img src={FptLogo} alt="Job" className="w-16 h-16 mr-3 object-cover rounded-lg" />
                                <div className="flex-1">
                                    <p className="text-black font-medium text-sm mb-1">FPT Software.</p>
                                    <div className="flex items-center">
                                        <h4 className="text-lg font-semibold">Software Developer</h4>
