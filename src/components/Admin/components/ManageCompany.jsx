...
// import {
//     getAllCompanies, getCompanyById, banCompany, inactiveCompany, activeCompany, unbanCompany
...
//                         onChange={(e) => {
//                             // setFilter({typeCompany: e.target.value });
//                             // setCurrentPage(1);
//                         }}
//                     >
...
//                         <option value="inactive">INACTIVE</option> {/* Cập nhật giá trị mặc định */}
...
//                         <TableRow key={company.id} onClick={() => handleOpenUpdateModal(company.id)} className="cursor-pointer hover:bg-slate-300">
...
//                             <TableCell className="text-center">
//                                 <span
//                                     className={`py-1 px-2 rounded-full text-xs ${company.statusCode.toLowerCase() === "active"
//                                         ? "bg-green-500 text-white"
//                                         : company.statusCode.toLowerCase() === "pending"
//                                             ? "bg-gray-500 text-white"
//                                             : company.statusCode.toLowerCase() === "banned"
//                                                 ? "bg-orange-500 text-white"
//                                                 : "bg-red-500 text-white"
//                                         }`}
//                                 >
//                                     {company.statusCode.toLowerCase() === "active"
//                                         ? "Active"
//                                         : company.statusCode.toLowerCase() === "pending"
//                                             ? "Pending"
//                                             : company.statusCode.toLowerCase() === "banned"
...
//                                 <DialogDescription>{currentCompanyDetail.description}</DialogDescription>
//                             </DialogHeader>
...
//                                     </div>
//                                     <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
//                                         <dt className="text-sm font-medium text-gray-500">Amount Employer</dt>
//                                         <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
...
//                                     </div>
//                                     <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
//                                         <dt className="text-sm font-medium text-gray-500">Type Company</dt>
//                                         <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
...
//                                     </div>
//                                     <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
//                                         <dt className="text-sm font-medium text-gray-500">Allow Hot Post</dt>
//                                         <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
//                                             {currentCompanyDetail.allowHotPost === 1 ? "Yes" : "No"}
//                                         </dd>
//                                     </div>
//                                     <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
//                                         <dt className="text-sm font-medium text-gray-500">Allow Cv</dt>
//                                         <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
...
//                                             {currentCompanyDetail.statusCode === 'pending' && (
//                                                 <>
//                                                     <button
...
//                                                 </>
//                                             )}
//                                             {currentCompanyDetail.statusCode === 'active' && (
...
//                                             )}
//                                             {currentCompanyDetail.statusCode === 'inactive' && (
//                                                 <button
//                                                     onClick={handleActive}
...
//                                                 </button>
//                                             )}
//                                             {currentCompanyDetail.statusCode === 'BANNED' && (
//                                                 <button
//                                                     onClick={handleUnban}
...
const ManageCompanyAdmin = () => {
    ...
    const handleStatusChange = (e) => {
        ...
        if (status === "ALL") {
            ...
            filtered = companies.filter(company => company.statusCode.toLowerCase() === status.toLowerCase());
        }
