...
const ManageCompanyAdmin = () => {
    ...
    const handleStatusChange = (e) => {
        ...
        if (status === "ALL") {
            ...
            filtered = companies.filter(company => company.statusCode.toUpperCase() === status.toUpperCase());
        }
                                ...
                                <dl>
                                    ...
                                    <div className="pt-6">
                                        <div className="flex justify-end">
                                            {currentCompanyDetail.statusCode.toUpperCase() === 'PENDING'.toUpperCase() && (
                                                <>
                                                    <button
                                            ...
                                            {currentCompanyDetail.statusCode.toUpperCase() === 'ACTIVE'.toUpperCase() && (
                                            ...
                                            {currentCompanyDetail.statusCode.toUpperCase() === 'INACTIVE'.toUpperCase() && (
                                                <button
                                                    onClick={handleActive}
                                            ...
                                            {currentCompanyDetail.statusCode.toUpperCase() === 'BANNED'.toUpperCase() && (
                                                <button
                                                    onClick={handleUnban}
