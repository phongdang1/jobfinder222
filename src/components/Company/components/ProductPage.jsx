          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-1/2 p-4">
              ...
              <div className="mb-4 flex gap-2 items-center">
                ...
                Display posts at the homepage to interact more candidates.
              </div>
              <div className="mb-4 flex gap-2 items-center">
                <IoIosCheckmarkCircle className="text-green-500 w-5 h-5" />
                Highlight and prioritize on the Job List page.
              </div>
              <div className="mb-4 flex gap-2 items-center">
                <IoIosCheckmarkCircle className="text-green-500 w-5 h-5" />
                An efficient way for your company to find ideal applicants.
              </div>
              <select
              ...
              <div className="mb-4 p-2  rounded-md flex justify-center items-center">
